...
import { appState, ucWalletAddresses, ucGetOpenTimestamp, ucUpsertPosition, ucFindWallet } from '../../infra/AppState';
import { buildLogPositionBlock, buildLogSnapshotHeader } from '../../bot/formatter';
import { MarketSnapshot, RawChainPosition, Dex, PositionRecord } from '../../types';
import { createServiceLogger, positionLogger } from '../../infra/logger';
...
export class PositionScanner {
    ...
    async logSnapshots(positions: PositionRecord[], bb?: MarketSnapshot | null, kLow?: number, kHigh?: number) {
        ...
        positionLogger.info(logContent);
